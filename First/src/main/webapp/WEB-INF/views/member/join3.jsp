					...
					<div class="join_content">
						...
						<div class="row_group">
							...
							<div class="join_row">
								...
								<span class="join_info_box_content ps_box"><!-- icon 안들어가서 int태그 지운다 -->
									<input type="text" id="uemail" name="email" class="join_info_box_input int" placeholder="선택입력" value='${user.email}'><span class="email_cnt"></span>
								</span>
								<span class="join_err_msg">필수 정보입니다.</span>
							</div>
							...
							<div class="join_row">
								...
								<span class="join_info_box_content ps_box"><!-- icon 안들어가서 int태그 지운다 -->
									<input type="tel" id="uphone" name="phone" class="join_info_box_input int" placeholder="-없이 입력, 예)01012345678" value='${user.phone}'>
								</span>
								<span class="join_err_msg">필수 정보입니다.</span>
							</div>
								...
								<div class="addr_wrap">
									<div class="postcode" style="display: flex;">
										<span class="join_info_box_content ps_box addr_poc">
											<input name = "postcode" type="text" id="sample6_postcode" class="join_info_box_input int addr_only" placeholder="우편번호" value='${user.postcode}' >
										</span>
									...
									<span class="join_info_box_content ps_box">
										<input name="addr1" type="text" id="sample6_address" class="join_info_box_input int addr_only" placeholder="주소" value='${user.addr1}' ><br>
									</span>									
									<span class="join_info_box_content ps_box">
										<input type="hidden" id="sample6_extraAddress" placeholder="참고항목">
										<input name="addr2" type="text" id="sample6_detailAddress" class="join_info_box_input int" placeholder="상세주소" value='${user.addr2}'>
									</span>
								</div>
								<span class="join_err_msg">필수 정보입니다.</span>
							</div>
...
$(function(){
	...
	if('${user}' !=''){
		...
		$('.join_row:eq(2)').css('visibility', 'hidden')
 							.css('height', '0px')
							.css('margin-top', '-17px');
		$('.join_row:eq(4)').css('visibility', 'hidden')
							.css('height', '0px')
							.css('margin-top', '-17px');
		$('.join_row:eq(5)').css('visibility', 'hidden')
							.css('height', '0px')
							.css('margin-top', '-17px');
		$('.join_info_box_input:eq(0)').attr('readonly','true').removeAttr('id');
		$('.join_info_box_input:eq(1)').attr('readonly','true').removeAttr('id');
