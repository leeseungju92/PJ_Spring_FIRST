		...
		<div class="modal_content">
			...
			<div id="loginEmailField">
				...
				<div>
						...
						<input id="login_id" class="item_inp item_tf" type="email" placeholder="id를 입력해주세요" name="" required>			
						<div class="div_input" style="position: relative;">
							
								<input id="login_pw" class="item_inp item_tf" type="password" placeholder="pw를 입력해주세요" name="" required minlength="6" maxlength="18">		
				...
				<div id="state">
					...
					<label for="loginck" class="lable1">&nbsp 로그인 상태유지</label>
				</div>
		...
		<div class="header_wrap">
			<div class="header_content">
				<div class="header_content_logo">
					<a href="#">
						<img class="header_content_logo_img" src="${path}/resources/img/FIRSTV3.png">						
				...
				<div class="header_content_member">
					...
					<a href="../include/FIRST_constract.html" style="margin-left: 3px;"><div><button type="button" class="btn btn-primary">회원가입</button></div></a>
				</div>
			</div>
		</div>
	</header>
